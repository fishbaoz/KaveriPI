 ...
 * @file
 *
 * AMD User options selection for a Kaveri FM2r2 platform solution system
 *
 ...
 * @e project:      AGESA
 * @e sub-project:  Core
 * @e \$Revision: 79299 $   @e \$Date: 2012-10-08 05:37:27 -0400 (Mon, 08 Oct 2012) $
 */
/*****************************************************************************
 *
 ...
 */
//#define BLDOPT_REMOVE_FAMILY_15_MODEL_1x_SUPPORT       TRUE
//#define BLDOPT_REMOVE_FAMILY_15_MODEL_3x_SUPPORT       TRUE
 ...
 */
// The level at which the VRM will instigate current reduction controls to protect the electrical components from damage
#define BLDCFG_VRM_SVI_OCP_LEVEL                144000

// Level of current that the VRM can supply for short amounts of time.
// ‘Short’ is also described as ‘thermally insignificant’ and is expected to be in the range of 10ms
#define BLDCFG_VRM_MAXIMUM_CURRENT_LIMIT        120000

// Level of current the VRM can supply on a continuous basis
#define BLDCFG_VRM_CURRENT_LIMIT                90000

// Level of current that the VRM can supply while in its ‘low power’ mode. The VRM designer,
// when providing this number, must account for any/all affects of the PState voltage changes ( including inrush currents, etc.)
#define BLDCFG_VRM_LOW_POWER_THRESHOLD          20000

// Rate at which the VRM can increase voltage. Typically listed in mv/uS.
// AMD spec lists 7.5mv/uS as a minimum. Some designs range upto 10mv/uS or 15mv/uS
#define BLDCFG_VRM_SLEW_RATE                    10000

// This signifies the amount of time in microseconds needed for the VRM to stabilize after reaching the target voltage
...
// The level at which the VRM will instigate current reduction controls to protect the electrical components from damage
#define BLDCFG_VRM_NB_SVI_OCP_LEVEL             96000

// Level of current that the VRM can supply for short amounts of time.
// ‘Short’ is also described as ‘thermally insignificant’ and is expected to be in the range of 10ms
#define BLDCFG_VRM_NB_MAXIMUM_CURRENT_LIMIT     60000

// Level of current the VRM can supply on a continuous basis
#define BLDCFG_VRM_NB_CURRENT_LIMIT             41000

// Level of current that the VRM can supply while in its ‘low power’ mode. The VRM designer,
// when providing this number, must account for any/all affects of the PState voltage changes ( including inrush currents, etc.)
#define BLDCFG_VRM_NB_LOW_POWER_THRESHOLD       20000  // Zero - disable NBPSI_L, Non-zero - enable NBPSI_L

// Rate at which the VRM can increase voltage. Typically listed in mv/uS.
// AMD spec lists 7.5mv/uS as a minimum. Some designs range upto 10mv/uS or 15mv/uS
#define BLDCFG_VRM_NB_SLEW_RATE                 10000
...
#define  BLDCFG_ACPI_SET_OEM_ID                 'A','M','D',' ',' ',' '             // This string must be 6 characters long.
#define  BLDCFG_ACPI_SET_OEM_TABLE_ID           'B','A','N','T','R','Y',' ',' '     // This string must be 8 characters long.
...
#define BLDCFG_MEMORY_ALL_CLOCKS_ON             TRUE //  FALSE
...
//#define BLDCFG_PCIE_REFCLK_SPREAD_SPECTRUM      36        // Richland: -0.36%
//#define BLDCFG_PCIE_REFCLK_SPREAD_SPECTRUM      375       // Kaveri: -0.375%
#define BLDCFG_PCIE_REFCLK_SPREAD_SPECTRUM      0         // uses GNB default value

//#ifndef ACPI_ALIB_SUPPORT
//  #define BLDOPT_REMOVE_ALIB                    TRUE
//#else
  #define BLDOPT_REMOVE_ALIB                    FALSE
//#endif

//#ifdef ACPI_IOMMU_SUPPORT
...
//define GNB IOAPIC base adress different from 0xFEC00000
#define BLDCFG_GNB_IOAPIC_ADDRESS	            0xFEC20000

//
// Bantry FCH GPP layout: 2  1x4 DT slot, 1 lane to LOM BCM5761, 1 lane to Mini PCIe slot
//
...
#define BLDCFG_FCH_GPP_PORT3_PRESENT          TRUE
...
//#define BLDCFG_IR_PIN_CONTROL                 0x33    // To use RX1 as IR, TX1 as FCH_ODD_DA
// 4 - 50MHz, 6 - 40MHz, 7 - 25MHz
#define BLDCFG_FCH_SD_CLOCK_CONTROL           7
