...
AMD_CPM_PCIE_TOPOLOGY_TABLE gCpmPcieTopologyTable = {
  ...
  {                                                                                                             // PCIe_PORT_DESCRIPTOR
    ...
    { // UMI Link
      ...
      PCIE_PORT_DATA_INITIALIZER_V2 (PortEnabled, ChannelTypeExt6db, 4, 1, HotplugDisabled, PcieGenMaxSupported, PcieGenMaxSupported, AspmL0sL1, DEVICE_ID_APU_SB_UMI, 0)
    }
  },
  {                                                                                                               // PCIe_DDI_DESCRIPTOR
...
AMD_CPM_PCIE_TOPOLOGY_TABLE gCpmPcieTopologyTable2 = {
  ...
  {                                                                                                             // PCIe_PORT_DESCRIPTOR
    ...
    { // UMI Link
      DESCRIPTOR_TERMINATE_LIST, //Descriptor flags  !!!IMPORTANT!!! Terminate last element of array
      PCIE_ENGINE_DATA_INITIALIZER (PciePortEngine, 0, 3),
      PCIE_PORT_DATA_INITIALIZER (PortEnabled, ChannelTypeExt6db, 8, HotplugDisabled, PcieGenMaxSupported, PcieGenMaxSupported, AspmL0sL1, DEVICE_ID_APU_SB_UMI)
    }
  },
  {                                                                                                             // PCIe_DDI_DESCRIPTOR
    {                                                                                                           // Port 0. Mini DDI slot
