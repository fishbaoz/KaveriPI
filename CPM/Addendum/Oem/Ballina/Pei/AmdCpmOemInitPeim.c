...
extern  AMD_CPM_GPIO_VDDP_VDDR_VOLTAGE_TABLE  gCpmSetVddpVddrVoltage;
...
extern  AMD_CPM_EXPRESS_CARD_TABLE            gCpmExpressCardTable;
extern  AMD_CPM_EXPRESS_CARD_TABLE            gCpmExpressCardTable2;
extern  AMD_CPM_WIRELESS_BUTTON_TABLE         gCpmWirelessButtonTable;
extern  AMD_CPM_WIRELESS_BUTTON_TABLE         gCpmWirelessButtonTable2;
...
extern  AMD_CPM_REBRAND_DUAL_GRAPHICS_SSID_TABLE gCpmRebrandDualGraphcisSsidTable;
...
AMD_CPM_MAIN_TABLE gCpmMainTable = {
  ...
  NULL,                               // Reserved for Internal Used
  NULL,                               // Reserved for Internal Used
  0xA400,                             // DisplayFeature: PowerXpressFixedMode
  0,                                  // ZeroPowerOdd
  0,                                  // AcpiThermalFan
  0,                                  // ExtClkGen
  0,                                  // UnusedGppClkOffEn
...
VOID *gCpmTableList[] = {
  ...
  &gCpmExpressCardTable2,
  &gCpmWirelessButtonTable,
  &gCpmWirelessButtonTable2,
  ...
  &gCpmRebrandDualGraphcisSsidTable,
