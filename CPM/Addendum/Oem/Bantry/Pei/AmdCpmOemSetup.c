  ...
  )
{
  ...
  SetupOption->PrimaryVideoAdaptor      = 0;
  SetupOption->UnusedGppClkOff          = 0;
  SetupOption->ClockRequest             = 0;
  SetupOption->AcpiThermalFanEn         = 0;
  SetupOption->GfxLinkCfg               = 0;
  SetupOption->OnboardLanSwitch         = 0;
  SetupOption->MiniPcieSlotEnable       = 0;
  SetupOption->WirelessLanRfEnable      = 0;
  SetupOption->PcieDdiDetection         = 0;
  ...
  if (!EFI_ERROR (Status)) {
    ...
    SetupOption->GfxLinkCfg               = CpmSetupOption.AMD_CPM_SETUP_OPTION_GFX_LINK_CFG;
    SetupOption->OnboardLanSwitch         = CpmSetupOption.AMD_CPM_SETUP_OPTION_ON_BOARD_LAN_EN;
    SetupOption->MiniPcieSlotEnable       = CpmSetupOption.AMD_CPM_SETUP_OPTION_MINI_PCIE_EN;
    SetupOption->WirelessLanRfEnable      = CpmSetupOption.AMD_CPM_SETUP_OPTION_WIRELESS_LAN_RF_EN;
    SetupOption->PcieDdiDetection         = CpmSetupOption.AMD_CPM_SETUP_OPTION_PCIE_DDI_DETECTION;
