...
AMD_CPM_PCIE_TOPOLOGY_TABLE gCpmPcieTopologyTable = {
  ...
  {   // PCIe_PORT_DESCRIPTOR
    ...
    { // UMI Link
      ...
      PCIE_ENGINE_DATA_INITIALIZER (PciePortEngine, APU_FCH_UMI_LANE_START_KV, APU_FCH_UMI_LANE_END_KV),
      PCIE_PORT_DATA_INITIALIZER_V2 (PortEnabled, ChannelTypeExt6db, APU_FCH_UMI_DEV_KV, APU_FCH_UMI_FUNC_KV, HotplugDisabled, PcieGenMaxSupported, PcieGenMaxSupported, AspmL0sL1, DEVICE_ID_APU_SB_UMI, 0)
    }
  },
  {   // PCIe_DDI_DESCRIPTOR
    { // DP_0: FCH Nutmeg VGA
...
AMD_CPM_PCIE_TOPOLOGY_TABLE gCpmPcieTopologyTable2 = {
  ...
  {   // PCIe_PORT_DESCRIPTOR
    ...
    { // UMI Link
      DESCRIPTOR_TERMINATE_LIST, //Descriptor flags  !!!IMPORTANT!!! Terminate last element of array
      PCIE_ENGINE_DATA_INITIALIZER (PciePortEngine, APU_FCH_UMI_LANE_START_TN, APU_FCH_UMI_LANE_END_TN),
      PCIE_PORT_DATA_INITIALIZER (PortEnabled, ChannelTypeExt6db, APU_FCH_UMI_DEV_TN, HotplugDisabled, PcieGenMaxSupported, PcieGenMaxSupported, AspmL0sL1, DEVICE_ID_APU_SB_UMI)
    }
  },
  {   // PCIe_DDI_DESCRIPTOR
    { // DP_0: FCH Nutmeg VGA
