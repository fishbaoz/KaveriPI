 ...
 *
 * Contains code that initialized Zero Power Odd before memory init.
 *
  ...
  )
{
  ...
  CpmTablePpiPtr->CommonFunction.PostCode (0xC00A);
  ...
  CpmTablePpiPtr->CommonFunction.PostCode (0xC10A);
