 ...
 * ***************************************************************************
 */
#ifndef _BOOT_TIME_RECORD_HOB_PEI_H_
#define _BOOT_TIME_RECORD_HOB_PEI_H_

#include <AmdCpmPei.h>

/// Hob to store Boot TimeRecord
typedef struct {
  AMD_BOOT_TIME_RECORD Record; ///< a Boot Time Record

} AMD_BOOT_TIME_RECORD_HOB;
