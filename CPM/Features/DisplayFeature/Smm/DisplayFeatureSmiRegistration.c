 ...
 *
 * Contains CPM code to perform Display Feature initialization in SMM
 *
  ...
  )
{
  ...
  if (DisplayFeatureDataPtr->CurrentFeature.Mask.PowerXpress && MainTablePtr->DisplayFeature.Config.DisableDgpuAudioInPX && !MainTablePtr->DisplayFeature.Config.DgpuDisplayOutput) {
    ...
    if (DisplayFeatureDataPtr->GfxDevicePfa[1].Raw) {
      ...
      BridgeCommand = CpmTableProtocolPtr->CommonFunction.PciRead32 (
                        CpmTableProtocolPtr,
      ...
      DeviceCommand = CpmTableProtocolPtr->CommonFunction.PciRead32 (
                        CpmTableProtocolPtr,
      ...
      CpmTableProtocolPtr->CommonFunction.PciOr8 (
                        CpmTableProtocolPtr,
                        DisplayFeatureDataPtr->GfxBridgePfa[1].Pfa.Bus,
                        DisplayFeatureDataPtr->GfxBridgePfa[1].Pfa.Device,
                        DisplayFeatureDataPtr->GfxBridgePfa[1].Pfa.Function,
      ...
      Mmiobase = CpmTableProtocolPtr->CommonFunction.PciRead32 (
                        CpmTableProtocolPtr,
                        DisplayFeatureDataPtr->GfxDevicePfa[1].Pfa.Bus,
                        DisplayFeatureDataPtr->GfxDevicePfa[1].Pfa.Device,
                        DisplayFeatureDataPtr->GfxDevicePfa[1].Pfa.Function,
      ...
      if (Mmiobase != 0xFFFFFFFF) {
        CpmTableProtocolPtr->CommonFunction.MmioAnd32 (
                        (Mmiobase & 0xFFFFFFF0) + RomStrapOffset,
                        0xFFFFEFFF
                        );
      }

      CpmTableProtocolPtr->CommonFunction.PciWrite32 (
                        CpmTableProtocolPtr,
                        DisplayFeatureDataPtr->GfxBridgePfa[1].Pfa.Bus,
                        DisplayFeatureDataPtr->GfxBridgePfa[1].Pfa.Device,
                        DisplayFeatureDataPtr->GfxBridgePfa[1].Pfa.Function,
  ...
  )
{
  ...
  if (DisplayFeatureTablePtr) {
    ...
    if (CpmTableProtocolPtr->MainTablePtr->DisplayFeature.Config.RebrandDualGraphics && RebrandDualGraphicsSsidTablePtr) {
...
{
  DisableDgpuAudioInPXSmm (DispatchHandle, (CPM_SMM_SW_DISPATCH_CONTEXT*)DispatchContext);
  SetGpuSsidSmm (DispatchHandle, (CPM_SMM_SW_DISPATCH_CONTEXT*)DispatchContext);
  SetGpuDisplayOutputSmm (DispatchHandle, (CPM_SMM_SW_DISPATCH_CONTEXT*)DispatchContext);
  return EFI_SUCCESS;
}
