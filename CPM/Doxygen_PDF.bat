...
IF DEFINED CPM_ROOT (PUSHD %CPM_ROOT%) ELSE (PUSHD .)

echo ----
echo Running Doxygen on Doxyfile in %CD%

doxygen Doxyfile 1>doxygen.out 2>&1
...
POPD
echo ----
echo Script failed! cpm.pdf not generated.
GOTO cleanup

:latexpass
copy refman.pdf ..\cpm.pdf 1>nul 2>&1
POPD
echo ----
echo Script complete! cpm.pdf is available in %CD%
