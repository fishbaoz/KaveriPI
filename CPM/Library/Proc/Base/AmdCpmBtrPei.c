  ...
  )
{
  ...
  Status = (**PeiServices).LocatePpi (PeiServices, &gBootTimeRecordPpiGuid,
                                        0, NULL, &BootTimeRecordPpi);
  if (!EFI_ERROR (Status)) {
  ...
  )
{
  ...
  Status = (**PeiServices).LocatePpi (PeiServices, &gPeiLastS3RestorePointPpiGuid, 0, NULL, NULL);
