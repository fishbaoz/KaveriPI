...
;/*---------------------------------------------------------------------------------------*/
;/**
; *  Read MXCSR registers
; *
; * @param[in]  RCX    Pointer to value
; */

PUBLIC  LibAmdReadMxcsr
LibAmdReadMxcsr PROC
        push rsi
        mov rsi, rcx
        stmxcsr     [rsi]
        pop rsi
...
;/*---------------------------------------------------------------------------------------*/
;/**
; *  Write MXCSR registers
; *
; * @param[in]  RCX    Pointer to value
; */

PUBLIC  LibAmdWriteMxcsr
LibAmdWriteMxcsr PROC
        push rsi
        mov rsi, rcx
        ldmxcsr     [rsi]
        pop rsi
