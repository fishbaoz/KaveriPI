...
#include <Protocol\AmdAgesaDxeProtocol.h>
#include <Protocol\AmdBufferManagerProtocol.h>
#include <Protocol\AmdInitMidProtocol.h>
#include <Protocol\AmdInitLateProtocol.h>

/*----------------------------------------------------------------------------------------
 *                   D E F I N I T I O N S    A N D    M A C R O S
 *----------------------------------------------------------------------------------------
 */
#define AGESA_DXE_PRIVATE_DATA_SIGNATURE   SIGNATURE_32('A', 'C', 'D', 'X')
