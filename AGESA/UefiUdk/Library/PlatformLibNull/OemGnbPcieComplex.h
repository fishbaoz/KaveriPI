...
#ifndef _OEMGNBPCIECOMPLEX_H_
#define _OEMGNBPCIECOMPLEX_H_
...
PCIe_PORT_DESCRIPTOR PortList [] = {
  ...
  {
    0,   //Descriptor flags
    PCIE_ENGINE_DATA_INITIALIZER (PcieUnusedEngine, 15, 8),
  ...
  // GPP x4 slot
  {
    ...
    PCIE_PORT_DATA_INITIALIZER (PortEnabled, ChannelTypeExt6db, 4, HotplugDisabled, PcieGenMaxSupported, PcieGenMaxSupported, AspmDisabled, BIT4)
  },
  {
    0,
...
PCIe_COMPLEX_DESCRIPTOR PcieComplexDescriptor = {
