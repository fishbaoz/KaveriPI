  ...
  )
{
  ...
  LibFchPciCfgModify ( PeiServices, EfiPeiPciCfgWidthUint8, FCH_PCICFG_ADDRESS (PciAddress), (UINTN) 0x20, 0);
  PciAddress = (PciDevice << 16) + FCH_OHCI_REG42;
  LibFchPciCfgModify ( PeiServices, EfiPeiPciCfgWidthUint8, FCH_PCICFG_ADDRESS (PciAddress), (UINTN) UsbPortBitMap, 0);

  PciAddress = (PciDevice << 16) + FCH_OHCI_REG51;
  LibFchPciCfgModify ( PeiServices, EfiPeiPciCfgWidthUint8, FCH_PCICFG_ADDRESS (PciAddress), (UINTN) 0, (UINTN) 0x20);
}
  ...
  )
{
  ...
  LibFchPciCfgWrite ( PeiServices, EfiPeiPciCfgWidthUint32, FCH_PCICFG_ADDRESS (PciAddress), &dInderData);
  ...
  )
{
  ...
  if (UsbBitMapPr->Usb3PortBM != 0 ) {
    ...
    LibFchPciCfgRead ( PeiServices,  EfiPeiPciCfgWidthUint32, FCH_PCICFG_ADDRESS (PciAddress), &dDword);
