...
*
*/
#ifndef _GNBFUSETABLEKV_H_
#define _GNBFUSETABLEKV_H_
...
typedef struct {
  ...
  FUSE_REGISTER_ENTRY_KV   *FuseRegisterTable;       ///< Pointer to field table
} FUSE_TABLE_ENTRY_KV;

/// Fuse translation table
typedef struct {
  UINT8                    FuseTableLength;          ///< Length of translation table
  FUSE_TABLE_ENTRY_KV      *FuseTable;               ///< Pointer to register table
} FUSE_TABLE_KV;
