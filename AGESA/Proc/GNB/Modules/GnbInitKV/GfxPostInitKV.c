...
#include  "Filecode.h"
#define FILECODE PROC_GNB_MODULES_GNBINITKV_GFXPOSTINITKV_FILECODE
/*----------------------------------------------------------------------------------------
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "GfxPostInterfaceKV Enter\n");
  GnbHandle = GnbGetHandle (StdHeader);
  ASSERT (GnbHandle != NULL);
  GnbRegisterReadKV (GnbHandle, D0F0xBC_xC0104000_TYPE,
      D0F0xBC_xC0104000_ADDRESS, &D0F0xBC_xC0104000.Value, 0, StdHeader);
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "GfxPostInterfaceKV Exit [0x%x]\n", Status);
  return  Status;
}
