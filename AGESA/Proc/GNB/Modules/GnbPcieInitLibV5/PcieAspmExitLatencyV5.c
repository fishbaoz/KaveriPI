...
#include  "Filecode.h"
#define FILECODE PROC_GNB_MODULES_GNBPCIEINITLIBV5_PCIEASPMEXITLATENCYV5_FILECODE
/*----------------------------------------------------------------------------------------
...
SCAN_STATUS
PcieAspmGetMinExitLatencyCallbackV5 (
  IN       PCI_ADDR             Device,
  ...
  )
{
  ...
  PcieExitLatencyData.ScanData.GnbScanCallback = PcieAspmGetMinExitLatencyCallbackV5;
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "  PcieAspmGetMinExitLatencyCallbackV5 for Device = %d:%d:%d\n",
    Device.Address.Bus,
