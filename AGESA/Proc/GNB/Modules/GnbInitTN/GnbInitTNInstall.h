...
//-----------------------------------------------------------------------
  ...
  GNB_SERVICE GnbPcieConfigServicesTN = {
  ...
  #define SERVICES_POINTER  &GnbPcieConfigServicesTN
#endif
  ...
  extern F_GFXMAPENGINETODISPLAYPATH GfxMapEngineToDisplayPathTN;
  extern F_GFXDISABLECONTROLLER      GfxDisableControllerTN;
  extern F_GFXCALCULATECLOCK         GfxCalculateClockTN;
  extern F_GFXISVBIOSPOSTED          GfxIsVbiosPostedTN;

  GFX_FAM_SERVICES GfxFamilyServiceProtocolTN = {
  ...
  GNB_SERVICE GfxFamilyServicesTN = {
    GfxFamService,
    AMD_FAMILY_TN,
    &GfxFamilyServiceProtocolTN,
    SERVICES_POINTER
  };
  #undef  SERVICES_POINTER
  #define SERVICES_POINTER  &GfxFamilyServicesTN

  extern F_GNBTIMESTAMP GnbTimeStampTN;

  GNB_FAM_TS_SERVICES GnbFamTsProtocolTN = {
    GnbTimeStampTN,
  };

  GNB_SERVICE GnbFamTsServicesTN = {
    GnbFamTsService,
    AMD_FAMILY_TN,
    &GnbFamTsProtocolTN,
    SERVICES_POINTER
  ...
  #undef  SERVICES_POINTER
  #define SERVICES_POINTER  &GnbFamTsServicesTN

  extern GNB_BUILD_OPTIONS_TN  GnbBuildOptionsTN;

  GNB_FAM_BUILDOPTIONS_POINTERS GnbOptionsProtocolTN = {
    &GnbBuildOptionsTN
  };

  GNB_SERVICE GnbOptionsServicesTN = {
    GnbFamBuildOptionPointer,
    AMD_FAMILY_TN,
    &GnbOptionsProtocolTN,
    SERVICES_POINTER
  };
  #undef  SERVICES_POINTER
  #define SERVICES_POINTER  &GnbOptionsServicesTN
