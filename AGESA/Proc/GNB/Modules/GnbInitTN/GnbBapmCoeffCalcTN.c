...
#include  "GnbInitTN.h"
#include  "Filecode.h"
#define FILECODE PROC_GNB_MODULES_GNBINITTN_GNBBAPMCOEFFCALCTN_FILECODE
/*----------------------------------------------------------------------------------------
  ...
  )
{
  ...
  for (Index = 0; Index < 15; Index++) {
    GnbRegisterReadTN (
      D0F0xBC_xE01040C4_TYPE,
      D0F0xBC_xE01040C4_ADDRESS + Index * 4,
      &RFuse1,
      0,
      StdHeader
      );
    GnbRegisterReadTN (
      D0F0xBC_xE01040C4_TYPE,
      D0F0xBC_xE01040C4_ADDRESS + (Index + 15) * 4,
      &TauFuse1,
      0,
      StdHeader
      );
