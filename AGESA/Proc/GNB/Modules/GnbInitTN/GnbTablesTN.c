 ...
 * @file
 *
 * Family-specific GNB initialization tables
 *
 *
 *
...
GNB_TABLE ROMDATA GnbEarlierInitTableAfterSmuTN [] = {
 ...
 //For all revA0 parts, we need to ensure that LL_*_Loadstep values (related to Loadline Optimization) are 0
  GNB_ENTRY_REV_RMW (
    AMD_F15_TN_A0,
    D0F0xBC_x1F87C_TYPE,
 ...
 GNB_ENTRY_COPY (
  ...
  GNB_ENTRY_REV_RMW (
    ...
    D18F5x188_TYPE,
    D18F5x188_ADDRESS,
    D18F5x188_NbLoadLineTrim_MASK,
    (3 << D18F5x188_NbLoadLineTrim_OFFSET)
  ),
  GNB_ENTRY_REV_RMW (
    AMD_F15_TN_A0,
    D18F5x12C_TYPE,
...
GNB_TABLE ROMDATA GnbEarlyInitTableTN [] = {
  ...
  GNB_ENTRY_COPY (
    ...
    D18F3xDC_TYPE,
    D18F3xDC_ADDRESS,
    D18F3xDC_PstateMaxVal_OFFSET,
    D18F3xDC_PstateMaxVal_WIDTH
    ),
  // Configure VPC
 ...
 // Enable TDC
  ...
  // Turn on Hybrid Boost by property
  GNB_ENTRY_FULL_RMW (
    TABLE_PROPERTY_HYBRID_BOOST,
    AMD_F15_RL_ALL,
    D0F0xBC_x1F428_TYPE,
    D0F0xBC_x1F428_ADDRESS,
    D0F0xBC_x1F428_EnableHybridBoost_MASK,
    (1 << D0F0xBC_x1F428_EnableHybridBoost_OFFSET)
    ),
  GNB_ENTRY_TERMINATE
};
...
//---------------------------------------------------------------------------
// Workaround for driver-less operation
  GNB_ENTRY_RMW (
    D18F5x170_TYPE,
    D18F5x170_ADDRESS,
    D18F5x170_SwNbPstateLoDis_MASK,
    0x1 << D18F5x170_SwNbPstateLoDis_OFFSET
    ),
//---------------------------------------------------------------------------
// ORB Init
...
//IOMMU L2 Initialization
  ...
  GNB_ENTRY_RMW (
    ...
    (0x0 << D0F2xF4_x90_CKGateL2BMiscDisable_OFFSET) | (0x1 << D0F2xF4_x90_CKGateL2BDynamicDisable_OFFSET) | (0x1 << D0F2xF4_x90_CKGateL2BRegsDisable_OFFSET) | (0x1 << D0F2xF4_x90_CKGateL2BCacheDisable_OFFSET)
    ),
  GNB_ENTRY_RMW (
    D0F2xF4_x92_TYPE,
    D0F2xF4_x92_ADDRESS,
...
// Trinity will not support the IOMMU performance counters so AGESA should clear D0F2x70[PcSupW]
  GNB_ENTRY_RMW (
    D0F2x70_TYPE,
    D0F2x70_ADDRESS,
    D0F2x70_PcSupW_MASK,
...
// IOMMU L2 clock gating
  ...
  GNB_ENTRY_PROPERTY_RMW (
    ...
    D0F2xF4_x90_TYPE,
    D0F2xF4_x90_ADDRESS,
    D0F2xF4_x90_CKGateL2BMiscDisable_MASK | D0F2xF4_x90_CKGateL2BRegsDisable_MASK | D0F2xF4_x90_CKGateL2BDynamicDisable_MASK | D0F2xF4_x90_CKGateL2BCacheDisable_MASK,
...
// Configure IOMMU Power Island
  ...
  GNB_ENTRY_WR (
    ...
    (PGFSM_DELAY_REG0_ADDRESS << D0F0xBC_xE0300018_RegAddr_OFFSET)
    ),
  GNB_ENTRY_STALL (1),
  GNB_ENTRY_WR (
    D0F0xBC_xE030001C_TYPE,
  ...
  GNB_ENTRY_WR (
    ...
    D0F0xBC_xE0300018_ADDRESS,
    (0xff << D0F0xBC_xE0300018_FsmAddr_OFFSET) | (1 << D0F0xBC_xE0300018_WriteOp_OFFSET) |
    (PGFSM_DELAY_REG1_ADDRESS << D0F0xBC_xE0300018_RegAddr_OFFSET)
    ),
  GNB_ENTRY_STALL (1),
  GNB_ENTRY_WR (
    D0F0xBC_xE030001C_TYPE,
  ...
  GNB_ENTRY_WR (
    ...
    D0F0xBC_xE0300018_ADDRESS,
    (0xff << D0F0xBC_xE0300018_FsmAddr_OFFSET) | (1 << D0F0xBC_xE0300018_WriteOp_OFFSET) |
    (PGFSM_CONTROL_REG_ADDRESS << D0F0xBC_xE0300018_RegAddr_OFFSET)
    ),
  GNB_ENTRY_STALL (1),
  GNB_ENTRY_RMW (
...
// Configure PCIe Power Island
  ...
  GNB_ENTRY_WR (
    ...
    (PGFSM_DELAY_REG0_ADDRESS << D0F0xBC_xE030000C_RegAddr_OFFSET)
    ),
  GNB_ENTRY_STALL (1),
  GNB_ENTRY_WR (
    D0F0xBC_xE0300010_TYPE,
  ...
  GNB_ENTRY_WR (
    ...
    D0F0xBC_xE030000C_ADDRESS,
    (0xff << D0F0xBC_xE030000C_FsmAddr_OFFSET) | (1 << D0F0xBC_xE030000C_WriteOp_OFFSET) |
    (PGFSM_DELAY_REG1_ADDRESS << D0F0xBC_xE030000C_RegAddr_OFFSET)
    ),
  GNB_ENTRY_STALL (1),
  GNB_ENTRY_WR (
    D0F0xBC_xE0300010_TYPE,
  ...
  GNB_ENTRY_PROPERTY_RMW (
    ...
    D0F0xBC_x1F428_TYPE,
    D0F0xBC_x1F428_ADDRESS,
    D0F0xBC_x1F428_EnableLoadline_MASK,
    (1 << D0F0xBC_x1F428_EnableLoadline_OFFSET)
    ),
  GNB_ENTRY_PROPERTY_WR (
    TABLE_PROPERTY_LOADLINE_ENABLE,
    SMU_MSG_TYPE,
...
// Shutdown IOMMU if disabled
  ...
  GNB_ENTRY_PROPERTY_POLL (
    ...
    D0F0xBC_xE0300208_TYPE,
    D0F0xBC_xE0300208_ADDRESS,
    D0F0xBC_xE0300208_P1PsoDaug_MASK,
    1 << D0F0xBC_xE0300208_P1PsoDaug_OFFSET
    ),
  GNB_ENTRY_STALL (10),
  GNB_ENTRY_PROPERTY_RMW (
    TABLE_PROPERTY_IOMMU_DISABLED,
