 ...
 * @file
 *
 * Family-specific Graphics initialization at AMD_INIT_ENV
 *
 *
 *
...
{
  D0F0xBC_xE000101C_STRUCT  D0F0xBC_xE000101C;
  D0F0xBC_xE0300328_STRUCT  D0F0xBC_xE0300328;
  ...
  GnbRegisterReadTN (D0F0xBC_xE000101C_TYPE, D0F0xBC_xE000101C_ADDRESS, &D0F0xBC_xE000101C.Value, 0, GnbLibGetHeader (Gfx));

  //Step 2: Check which SIMD has been disabled
  for (n = 0; n < 6; n++) {
    if (((Property & TABLE_PROPERTY_IGFX_DISABLED) != 0) || ((D0F0xBC_xE000101C.Field.InactiveSimds >> n) & 0x1)) {
      ...
      GnbRegisterReadTN (D0F0xBC_xE0300328_TYPE, D0F0xBC_xE0300328_ADDRESS, &D0F0xBC_xE0300328.Value, 0, GnbLibGetHeader (Gfx));
      D0F0xBC_xE0300328.Value |= (0x1 << (D0F0xBC_xE0300328_Simd0PgfsmClockEn_OFFSET + n));
      GnbRegisterWriteTN (D0F0xBC_xE0300328_TYPE, D0F0xBC_xE0300328_ADDRESS, &D0F0xBC_xE0300328.Value, GNB_REG_ACC_FLAG_S3SAVE, GnbLibGetHeader (Gfx));
      //Step 6
      ...
      //Step 9: Wait for PSO daughter to be asserted for SIMD n - skip A0
      if ((LogicalId.Revision & AMD_F15_TN_A0) != AMD_F15_TN_A0) {
        ...
        IDS_HDT_CONSOLE (GNB_TRACE, "Step 9: Wait for PSO daughter to be asserted for SIMD n - skip A0\n");
      }
      //Step 10: Turn off PGFSM clock
      GnbRegisterReadTN (D0F0xBC_xE0300328_TYPE, D0F0xBC_xE0300328_ADDRESS, &D0F0xBC_xE0300328.Value, 0, GnbLibGetHeader (Gfx));
      D0F0xBC_xE0300328.Value &= (~ (UINT64) (0x1 << (D0F0xBC_xE0300328_Simd0PgfsmClockEn_OFFSET + n)));
      GnbRegisterWriteTN (D0F0xBC_xE0300328_TYPE, D0F0xBC_xE0300328_ADDRESS, &D0F0xBC_xE0300328.Value, GNB_REG_ACC_FLAG_S3SAVE, GnbLibGetHeader (Gfx));
    }
  }
  ...
  )
{
  ...
  if (D0F0xBC_xE000101C.Field.RbBackendDisable == 0x1) {
    RbNumber = 0;
    Mask1 = 0x3FFFA;
    Mask2 = 0x5;
  } else if (D0F0xBC_xE000101C.Field.RbBackendDisable == 0x2) {
    RbNumber = 1;
    Mask1 = 0x3FFF5;
    Mask2 = 0xA;
  } else {
  ...
  for (i = RbNumber; i < 4; i += 2) {
    D0F0xBC_xE0300100.Value = (5 << PGFSM_DELAY_REG0_MemShutdownDelay_OFFSET) | (4 << PGFSM_DELAY_REG0_IsolationDelay_OFFSET) | (10 << PGFSM_DELAY_REG0_ResetDelay_OFFSET); //reg0
    ...
    D0F0xBC_xE03000FC.Field.RegAddr = PGFSM_DELAY_REG0_ADDRESS;
    ...
    D0F0xBC_xE0300100.Value = (50 << PGFSM_DELAY_REG1_MotherDelay_OFFSET) | (50 << PGFSM_DELAY_REG1_DaughterDelay_OFFSET); //reg1
    GnbRegisterWriteTN (D0F0xBC_xE0300100_TYPE, D0F0xBC_xE0300100_ADDRESS, &D0F0xBC_xE0300100.Value, GNB_REG_ACC_FLAG_S3SAVE, GnbLibGetHeader (Gfx));
    D0F0xBC_xE03000FC.Field.RegAddr = PGFSM_DELAY_REG1_ADDRESS;
    GnbRegisterWriteTN (D0F0xBC_xE03000FC_TYPE, D0F0xBC_xE03000FC_ADDRESS, &D0F0xBC_xE03000FC.Value, GNB_REG_ACC_FLAG_S3SAVE, GnbLibGetHeader (Gfx));
    GnbLibStallS3Save (1, GnbLibGetHeader (Gfx));

    D0F0xBC_xE0300100.Value = 0; //control
    GnbRegisterWriteTN (D0F0xBC_xE0300100_TYPE, D0F0xBC_xE0300100_ADDRESS, &D0F0xBC_xE0300100.Value, GNB_REG_ACC_FLAG_S3SAVE, GnbLibGetHeader (Gfx));
    D0F0xBC_xE03000FC.Field.RegAddr = PGFSM_CONTROL_REG_ADDRESS;
    GnbRegisterWriteTN (D0F0xBC_xE03000FC_TYPE, D0F0xBC_xE03000FC_ADDRESS, &D0F0xBC_xE03000FC.Value, GNB_REG_ACC_FLAG_S3SAVE, GnbLibGetHeader (Gfx));
    GnbLibStallS3Save (1, GnbLibGetHeader (Gfx));
  }
  ...
  GnbRegisterReadTN (D0F0xBC_xE0300328_TYPE, D0F0xBC_xE0300328_ADDRESS, &D0F0xBC_xE0300328.Value, 0, GnbLibGetHeader (Gfx));
  D0F0xBC_xE0300328.Field.GfxPgfsmClockEn = 1;
  GnbRegisterWriteTN (D0F0xBC_xE0300328_TYPE, D0F0xBC_xE0300328_ADDRESS, &D0F0xBC_xE0300328.Value, GNB_REG_ACC_FLAG_S3SAVE, GnbLibGetHeader (Gfx));
  ...
  )
{
  ...
  ShutDownDisabledSimd = GnbBuildOptionsTN.CfgUnusedSimdPowerGatingEnable;
  ShutDownDisabledRb = GnbBuildOptionsTN.CfgUnusedRbPowerGatingEnable;
