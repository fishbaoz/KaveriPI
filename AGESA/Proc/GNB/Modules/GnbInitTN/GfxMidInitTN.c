 ...
 * @file
 *
 * Family-specific graphics initialization at AMD_INIT_MID
 *
 *
 *
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "GfxAzWorkaroundTN Enter\n");
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "GfxAzWorkaroundTN Exit\n");
  return;
}
