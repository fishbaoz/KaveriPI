  ...
  )
{
  ...
  if (Wrapper->Features.PowerOffUnusedPlls != 0) {
    ...
    if (AllLanes != UnusedLanes) {
      //Some lanes end up being used. We should keep master PLL powered up
...
/*----------------------------------------------------------------------------------------*/
/**
 * Lane bitmap to enable PLL power down in L1
 *
 *
  ...
  )
{
  ...
  if (Wrapper->Features.ClkGating == 0x1) {
    ...
    D0F0xE4_WRAP_8015.Field.SlowRefclkThroughTxclk2p5x = 0x0;
    D0F0xE4_WRAP_8015.Field.SlowRefclkEnableTxclk2p5x = 0x0;
    D0F0xE4_WRAP_8015.Field.SlowRefclkDivideTxclk2p5x = 0x3;
    D0F0xE4_WRAP_8015.Field.SlowRefclkBurstTxclk2p5x = 0x1;
    D0F0xE4_WRAP_8015.Field.SlowRefclkLcntGateForce = 0x0;
    D0F0xE4_WRAP_8015.Field.SlowRefclkThroughTxclk1x = 0x0;
    D0F0xE4_WRAP_8015.Field.SlowRefclkEnableTxclk1x = 0x0;
    D0F0xE4_WRAP_8015.Field.SlowRefclkDivideTxclk1x = 0x1;
    D0F0xE4_WRAP_8015.Field.SlowRefclkBurstTxclk1x = 0x1;
