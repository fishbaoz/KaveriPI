...
INT8  DeemPh35Gen2Nom [] = {    42,        64,       0,      42,      64,       77};
INT8  Deemph60Gen2NOm [] = {    42,        64,       0,      42,      64,       77};
  ...
  )
{
  ...
  for (Lane = StartLane; Lane <= EndLane; Lane++) {
    ...
    PcieRegisterRMW (
      ...
      DeemPh35Gen2Nom[ChannelType] << D0F0xE4_PHY_6006_Deemph35Gen2Nom_OFFSET,
      FALSE,
      Pcie
      );
    PcieRegisterRMW (
      ...
      Deemph60Gen2NOm[ChannelType] << D0F0xE4_PHY_6006_Deemph60Gen2Nom_OFFSET,
      FALSE,
      Pcie
      );
  }
