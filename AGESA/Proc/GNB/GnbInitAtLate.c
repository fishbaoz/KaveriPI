  ...
  )
{
  ...
  GnbCommonOptions = (GNB_BUILD_OPTIONS_COMMON*) GnbFmGnbBuildOptions (&LateParamsPtr->StdHeader);
  Property = TABLE_PROPERTY_DEFAULT;
  Property |= GnbCommonOptions->CfgBapmSupport ? TABLE_PROPERTY_BAPM : 0;
  ...
  GnbLateConfigPtr->GnbIoapicId = 0xFF;
  GnbLateConfigPtr->FchIoapicId = 0xFF;
}
