...
// CKE tri-state
//
STATIC CONST UINT8 ROMDATA TNDdr3CKETri[] = {0xFF, 0xFF, 0xFF, 0xFF};
CONST PSC_TBL_ENTRY TNDdr3CKETriEnt = {
   {PSCFG_CKETRI, DT_DONT_CARE, NOD_DONT_CARE, {AMD_FAMILY_15_TN, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY},
