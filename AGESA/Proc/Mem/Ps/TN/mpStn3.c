...
STATIC CONST PSCFG_SAO_ENTRY TNSODdr3SAO[] = {
  ...
  {_2DIMM, DDR1600, V1_5, DIMM_SR + DIMM_DR, DIMM_SR + DIMM_DR, NP, 1, 0x00000033, 0x30222323},
  {_2DIMM, DDR1866, V1_5, NP, DIMM_SR, NP, 0, 0x003C3C3C, 0x30112222},
  {_2DIMM, DDR1866, V1_5, NP, DIMM_DR, NP, 1, 0x00003C3C, 0x30112222}
};
...
// Max Freq. for other CPU package, like FM2 normal SODIMM configuration
// Format :
...
CONST PSC_TBL_ENTRY TNMaxFreqTblEntSO = {
   {PSCFG_MAXFREQ, SODIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_TN, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY},
