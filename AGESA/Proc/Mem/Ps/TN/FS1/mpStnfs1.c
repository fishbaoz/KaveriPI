...
CONST PSC_TBL_ENTRY TNClkDisMapEntSOFS1 = {
   {PSCFG_CLKDIS, SODIMM_TYPE + UDIMM_TYPE, _1DIMM, {AMD_FAMILY_15_TN, AMD_F15_ALL}, TN_SOCKET_FS1, DDR3_TECHNOLOGY},
...
CONST PSC_TBL_ENTRY TNSODdr3ODTTriEntFS1 = {
   {PSCFG_ODTTRI, SODIMM_TYPE + UDIMM_TYPE, _1DIMM, {AMD_FAMILY_15_TN, AMD_F15_ALL}, TN_SOCKET_FS1, DDR3_TECHNOLOGY},
...
CONST PSC_TBL_ENTRY TNSODdr3CSTriEntFS1 = {
   {PSCFG_CSTRI, SODIMM_TYPE + UDIMM_TYPE, _1DIMM, {AMD_FAMILY_15_TN, AMD_F15_ALL}, TN_SOCKET_FS1, DDR3_TECHNOLOGY},
   sizeof (TNSODdr3CSTriFS1) / sizeof (UINT8),
   (VOID *)&TNSODdr3CSTriFS1
};

// Max Freq. for FS1 SODIMM configuration
// Format :
// DimmPerCh,   Dimms,   SR,   DR,   QR,   Speed1_5V,   Speed1_35V,   Speed1_25V
//
STATIC CONST PSCFG_MAXFREQ_ENTRY ROMDATA MaxFreqTNSODIMMFS1[] = {
...
CONST PSC_TBL_ENTRY TNMaxFreqTblEntSOFS1 = {
   {PSCFG_MAXFREQ, SODIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_TN, AMD_F15_ALL}, TN_SOCKET_FS1, DDR3_TECHNOLOGY},
   sizeof (MaxFreqTNSODIMMFS1) / sizeof (PSCFG_MAXFREQ_ENTRY),
   (VOID *)&MaxFreqTNSODIMMFS1
};