...
STATIC CONST PSCFG_SAO_ENTRY TNUDdr3SAO[] = {
  ...
  {_2DIMM, DDR1600, V1_35, DIMM_SR + DIMM_DR, DIMM_SR + DIMM_DR, NP, 1, 0x0000002B, 0x30222322},
  ...
  {_2DIMM, DDR1866, V1_5, DIMM_SR + DIMM_DR, DIMM_SR + DIMM_DR, NP, 1, 0x00000031, 0x30222322},
  {_2DIMM, DDR2133, V1_5, NP, DIMM_SR, NP, 0, 0x00000000, 0x30112222},
  {_2DIMM, DDR2133, V1_5, NP, DIMM_DR, NP, 1, 0x00000000, 0x30112222}
};
CONST PSC_TBL_ENTRY TNSAOTblEntU3 = {
   {PSCFG_SAO, UDIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_TN, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY},
...
STATIC CONST PSCFG_RTT_ENTRY DramTermTNUDIMM[] = {
  ...
  {_2DIMM, DDR1600, V1_5 + V1_35, DIMM_SR + DIMM_DR, DIMM_SR + DIMM_DR, NP, DIMM_SR + DIMM_DR, R0 + R1, 4, 1},
  {_2DIMM, DDR1866, V1_5, NP, DIMM_SR + DIMM_DR, NP, DIMM_SR + DIMM_DR, R0 + R1, 3, 0},
  {_2DIMM, DDR1866, V1_5, DIMM_SR + DIMM_DR, DIMM_SR + DIMM_DR, NP, DIMM_SR + DIMM_DR, R0 + R1, 4, 1},
  {_2DIMM, DDR2133, V1_5, NP, DIMM_SR + DIMM_DR, NP, DIMM_SR + DIMM_DR, R0 + R1, 3, 0}
};
CONST PSC_TBL_ENTRY TNDramTermTblEntU = {
   {PSCFG_RTT, UDIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_TN, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY},
   sizeof (DramTermTNUDIMM) / sizeof (PSCFG_RTT_ENTRY),
   (VOID *)&DramTermTNUDIMM
};

//
// Max Freq. for other TN CPU package, like FP2
// Format :
// DimmPerCh,   Dimms,   SR,   DR,   QR,   Speed1_5V,   Speed1_35V,   Speed1_25V
//
STATIC CONST PSCFG_MAXFREQ_ENTRY ROMDATA TNMaxFreqUDIMM[] = {
...
CONST PSC_TBL_ENTRY TNMaxFreqTblEntU = {
   {PSCFG_MAXFREQ, UDIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_TN, AMD_F15_TN_ONLY}, PT_DONT_CARE, DDR3_TECHNOLOGY},
   sizeof (TNMaxFreqUDIMM) / sizeof (PSCFG_MAXFREQ_ENTRY),
   (VOID *)&TNMaxFreqUDIMM
};

//
// Max Freq. for other RL CPU package, like FP2
// Format :
// DimmPerCh,   Dimms,   SR,   DR,   QR,   Speed1_5V,   Speed1_35V,   Speed1_25V
//
STATIC CONST PSCFG_MAXFREQ_ENTRY ROMDATA RLMaxFreqUDIMM[] = {
  {_1DIMM, 1, 1, 0, 0, DDR1600_FREQUENCY, DDR1600_FREQUENCY, DDR1333_FREQUENCY},
  {_1DIMM, 1, 0, 1, 0, DDR1600_FREQUENCY, DDR1600_FREQUENCY, DDR1333_FREQUENCY},
  {_2DIMM, 1, 1, 0, 0, DDR1600_FREQUENCY, DDR1333_FREQUENCY, DDR1333_FREQUENCY},
  {_2DIMM, 1, 0, 1, 0, DDR1600_FREQUENCY, DDR1333_FREQUENCY, DDR1333_FREQUENCY},
...
CONST PSC_TBL_ENTRY RLMaxFreqTblEntU = {
   {PSCFG_MAXFREQ, UDIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_RL, AMD_F15_RL_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY},
   sizeof (RLMaxFreqUDIMM) / sizeof (PSCFG_MAXFREQ_ENTRY),
   (VOID *)&RLMaxFreqUDIMM
};
