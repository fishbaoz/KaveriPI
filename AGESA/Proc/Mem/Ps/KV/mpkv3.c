 ...
 * mpkv3.c
 *
 * Platform specific settings for KV
 *
...
#define FILECODE PROC_MEM_PS_KV_MPKV3_FILECODE
/*----------------------------------------------------------------------------
 ...
 */
//
// Common tables of KV platform specific configuration
//
...
//
STATIC CONST PSCFG_2D_ODTPAT_ENTRY KVOdtPat[] = {
...
CONST PSC_TBL_ENTRY KVOdtPatTblEnt = {
   {PSCFG_ODT_PAT_2D, DT_DONT_CARE, NOD_DONT_CARE, {AMD_FAMILY_15_KV, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY},
   sizeof (KVOdtPat) / sizeof (PSCFG_2D_ODTPAT_ENTRY),
   (VOID *)&KVOdtPat
};
