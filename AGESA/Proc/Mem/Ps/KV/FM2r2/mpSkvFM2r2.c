...
#define FILECODE PROC_MEM_PS_KV_MPSKVFM2r2_FILECODE
/*----------------------------------------------------------------------------
...
//
STATIC CONST PSCFG_MAXFREQ_ENTRY ROMDATA MaxFreqKVSODIMMFM2r2[] = {
...
CONST PSC_TBL_ENTRY KVMaxFreqTblEntSOFM2r2 = {
   {PSCFG_MAXFREQ, SODIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_KV, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY},
   sizeof (MaxFreqKVSODIMMFM2r2) / sizeof (PSCFG_MAXFREQ_ENTRY),
   (VOID *)&MaxFreqKVSODIMMFM2r2
};
