 ...
 * mpUkv3.c
 *
 * Platform specific settings for KV DDR3 UDIMM system
 *
...
#define FILECODE PROC_MEM_PS_KV_MPUKV3_FILECODE
/*----------------------------------------------------------------------------
...
//
STATIC CONST PSCFG_CADBUS_ENTRY ROMDATA CadBusKVUDIMM[] = {
  ...
  {2, DDR2400, V1_5                , NP     , DIMM_SR, 0, 0x003B3B3B, 0x1F, 0x1F, 0x1F, 0x1F},
  {2, DDR2400, V1_5                , NP     , DIMM_DR, 1, 0x00003B3B, 0x1F, 0x1F, 0x1F, 0x1F},
};
CONST PSC_TBL_ENTRY KVCadBusTblEnU = {
   {PSCFG_CADBUS, UDIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_KV, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY},
   sizeof (CadBusKVUDIMM) / sizeof (PSCFG_CADBUS_ENTRY),
   (VOID *)&CadBusKVUDIMM
};
...
//
STATIC CONST PSCFG_DATABUS_ENTRY ROMDATA DataBusKVUDIMM[] = {
  ...
  {2, DDR2400, V1_5                , NP     , DIMM_SR, ODT_40 , ODT_OFF, 0x70, 0x70, 0x0C},
  {2, DDR2400, V1_5                , NP     , DIMM_DR, ODT_40 , ODT_OFF, 0x70, 0x70, 0x0C},
};
CONST PSC_TBL_ENTRY KVDataBusTblEnU = {
   {PSCFG_DATABUS, UDIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_KV, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY},
   sizeof (DataBusKVUDIMM) / sizeof (PSCFG_DATABUS_ENTRY),
   (VOID *)&DataBusKVUDIMM
};
