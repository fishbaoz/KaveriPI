...
MSR_SPECIAL_CASE MsrSpecialCaseFuncTN[] = {
...
PCI_REG_DESCRIPTOR ROMDATA S3PciPreSelfRefDescriptorTN[] = {
  ...
  {{0, 0, 0}, FUNC_5, 0x160, 0x0021FC00},
  {{0, 0, 0}, FUNC_5, 0x164, 0x0021FC00},
  {{0, 0, 0}, FUNC_5, 0x168, 0x0021FC00},
  {{0, 0, 0}, FUNC_5, 0x16C, 0x0021FC00}
};
