  ...
  )
{
  ...
  IDS_PERF_TIMESTAMP (TP_BEGINMEMMFLOWTN, &(MemMainPtr->MemPtr->StdHeader));
  //----------------------------------------------------------------
  ...
  IDS_PERF_TIMESTAMP (TP_BEGINMEMINITIALIZEMCT, &(MemMainPtr->MemPtr->StdHeader));
  if (!NBPtr[BSP_DIE].InitializeMCT (&NBPtr[BSP_DIE])) {
    return AGESA_FATAL;
  }
  IDS_PERF_TIMESTAMP (TP_ENDMEMINITIALIZEMCT, &(MemMainPtr->MemPtr->StdHeader));
  ...
  IDS_PERF_TIMESTAMP (TP_BEGINMEMSYSTEMMEMORYMAPPING, &(MemMainPtr->MemPtr->StdHeader));
  if (!NBPtr[BSP_DIE].HtMemMapInit (&NBPtr[BSP_DIE])) {
    return AGESA_FATAL;
  }
  IDS_PERF_TIMESTAMP (TP_ENDMEMSYSTEMMEMORYMAPPING, &(MemMainPtr->MemPtr->StdHeader));
  ...
  //----------------------------------------------------------------
  MemNConfigureDctNormalTN (&NBPtr[BSP_DIE]);
  ...
  IDS_PERF_TIMESTAMP (TP_BEGINMEMOTHERTIMING, &(MemMainPtr->MemPtr->StdHeader));

  if (!NBPtr[BSP_DIE].OtherTiming (&NBPtr[BSP_DIE])) {
    return AGESA_FATAL;
  }
  IDS_PERF_TIMESTAMP (TP_ENDMEMOTHERTIMING, &(MemMainPtr->MemPtr->StdHeader));
  ...
  IDS_PERF_TIMESTAMP (TP_BEGINMEMMEMCLR, &(MemMainPtr->MemPtr->StdHeader));

  if (!MemFeatMain.MemClr (MemMainPtr)) {
    return AGESA_FATAL;
  }
  IDS_PERF_TIMESTAMP (TP_ENDMEMMEMCLR, &(MemMainPtr->MemPtr->StdHeader));
  ...
  IDS_PERF_TIMESTAMP (TP_BEGINMEMUMAMEMTYPING, &(MemMainPtr->MemPtr->StdHeader));

  if (!MemFeatMain.UmaAllocation (MemMainPtr)) {
    return AGESA_FATAL;
  }

  IDS_PERF_TIMESTAMP (TP_ENDMEMUMAMEMTYPING, &(MemMainPtr->MemPtr->StdHeader));
  //----------------------------------------------------------------
  // Interleave region
  //----------------------------------------------------------------
  ...
  IDS_PERF_TIMESTAMP (TP_ENDMEMMFLOWTN, &(MemMainPtr->MemPtr->StdHeader));
