...
#define FILECODE PROC_RECOVERY_MEM_PS_TN_MRPUTN3_FILECODE
/*----------------------------------------------------------------------------
...
//
STATIC CONST PSCFG_SAO_ENTRY RecTNUDdr3SAO[] = {
...
// 1 60ohms
// 2 120ohms
STATIC CONST PSCFG_RTT_ENTRY RecDramTermTNUDIMM[] = {
...
CONST PSC_TBL_ENTRY RecTNDramTermTblEntU = {
   {PSCFG_RTT, UDIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_TN, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY},
   sizeof (RecDramTermTNUDIMM) / sizeof (PSCFG_RTT_ENTRY),
   (VOID *)&RecDramTermTNUDIMM
};
