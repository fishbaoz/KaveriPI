  ...
  )
{
  ...
  if ( LocalCfgPtr->EcKbd == ENABLED) {
    ...
    //
    RwEc8 (FCH_EC_REG07, 0x00, 0x07, StdHeader);
    RwEc8 (FCH_EC_REG30, 0x00, 0x01, StdHeader);
  }
  ...
  if (IsImcEnabled (StdHeader) && ( LocalCfgPtr->EcChannel0 == ENABLED)) {
    ...
    //Logical device 0x03
    //
    RwEc8 (FCH_EC_REG07, 0x00, 0x03, StdHeader);
    RwEc8 (FCH_EC_REG60, 0x00, 0x00, StdHeader);
    RwEc8 (FCH_EC_REG61, 0x00, 0x62, StdHeader);
    RwEc8 (FCH_EC_REG30, 0x00, 0x01, StdHeader);                    ///;Enable Device 3
  }
