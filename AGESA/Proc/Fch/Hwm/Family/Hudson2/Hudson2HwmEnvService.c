...
//Temperature At
#define Hudson2_T0AT        5220
#define Hudson2_T1AT        5225
#define Hudson2_T2AT        5220
#define Hudson2_T3AT        5212
#define Hudson2_T4AT        5123

//Temperature Ct
#define Hudson2_T0CT        27365
#define Hudson2_T1CT        27435
#define Hudson2_T2CT        27516
#define Hudson2_T3CT        27580
#define Hudson2_T4CT        27866

FCH_HWM_TEMP_PAR TempParDefault[] = {
  { Hudson2_T0AT, Hudson2_T0CT , 0 },
  { Hudson2_T1AT, Hudson2_T1CT , 0 },
  { Hudson2_T2AT, Hudson2_T2CT , BIT0 },         ///High Ratio
  { Hudson2_T3AT, Hudson2_T3CT , BIT1 },         ///High Current
  { Hudson2_T4AT, Hudson2_T4CT , 0 }
};
  ...
  )
{
  ...
  RwMem (ACPI_MMIO_BASE + MISC_BASE + FCH_MISC_REG50, AccessWidth32, ~(UINT32) (BIT11 + BIT20), (BIT11 + BIT20));
