  ...
  )
{
  ...
  if (LocalCfgPtr->Hwm.HwmFchtsiAutoPoll == 1) {
    ...
    LibAmdIoWrite (AccessWidth8, SmbusBase + FCH_SMB_IOREG00, &ValueByte, StdHeader);
    ValueByte = FCH_SMB_CMD_BYTE_DATA;
    LibAmdIoWrite (AccessWidth8, SmbusBase + FCH_SMB_IOREG02, &ValueByte, StdHeader);
    ValueByte = SBTSI_REG09;
    LibAmdIoWrite (AccessWidth8, SmbusBase + FCH_SMB_IOREG03, &ValueByte, StdHeader);
    ValueByte = SBTSI_ADDR;
    LibAmdIoWrite (AccessWidth8, SmbusBase + FCH_SMB_IOREG04, &ValueByte, StdHeader);
    ValueByte = SBTSI_READORDER;
    LibAmdIoWrite (AccessWidth8, SmbusBase + FCH_SMB_IOREG05, &ValueByte, StdHeader);
    ValueByte = FCH_SMB_CMD_BYTE_DATA_START;
    LibAmdIoWrite (AccessWidth8, SmbusBase + FCH_SMB_IOREG02, &ValueByte, StdHeader);

    LibAmdIoRead (AccessWidth8, SmbusBase + FCH_SMB_IOREG00, &ValueByte, StdHeader);
    ...
    LibAmdIoWrite (AccessWidth8, SmbusBase + FCH_SMB_IOREG14, &ValueByte, StdHeader);
    ValueByte = SBTSI_REG01;
    LibAmdIoWrite (AccessWidth8, SmbusBase + FCH_SMB_IOREG17, &ValueByte, StdHeader);
