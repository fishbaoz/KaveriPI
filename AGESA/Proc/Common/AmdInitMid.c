  ...
  )
{
  ...
  GnbInitDataStructAtMidDef (&MidParamsPtr->GnbMidConfiguration, MidParamsPtr);
  ...
  )
{
  ...
  IDS_PERF_TIMESTAMP (TP_BEGINPROCAMDINITMID, &MidParams->StdHeader);
  ...
  IDS_PERF_TIMESTAMP (TP_BEGININITMID, &MidParams->StdHeader);
  CalledStatus = BldoptFchFunction.InitMid (MidParams);
  AgesaStatus = (CalledStatus > AgesaStatus) ? CalledStatus : AgesaStatus;
  IDS_PERF_TIMESTAMP (TP_ENDINITMID, &MidParams->StdHeader);

  IDS_PERF_TIMESTAMP (TP_BEGINGNBINITATMID, &MidParams->StdHeader);
  CalledStatus = GnbInitAtMid (MidParams);
  if (CalledStatus > AgesaStatus) {
    AgesaStatus = CalledStatus;
  }
  IDS_PERF_TIMESTAMP (TP_ENDGNBINITATMID, &MidParams->StdHeader);
  ...
  IDS_PERF_TIMESTAMP (TP_ENDPROCAMDINITMID, &MidParams->StdHeader);
