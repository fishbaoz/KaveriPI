  ...
  )
{
  ...
  PlatformConfig->CpuFrequencyLimit = UserOptions.CfgCpuFrequencyLimit;
  PlatformConfig->CfgPlatformConnectedStandbyMode = UserOptions.CfgPlatformConnectedStandbyMode;
  ...
  PlatformConfig->AcpSize = UserOptions.CfgGnbAcpSize;
