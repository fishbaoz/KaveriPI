 ...
 *    -4      microcode patch loading
 *    -5      namestring determination/programming
 *    -6      AP initialization
 *    -7      power management initialization
 *    -8      core leveling
 *
  ...
  )
{
  ...
  FamilySpecificServices->GetEarlyInitBeforeApLaunchOnCoreTable (FamilySpecificServices, &EarlyTableOnCore, &CpuEarlyParams, StdHeader);
  ...
  )
{
  ...
  GetCpuServicesOfCurrentCore (&FamilySpecificServices, StdHeader);
  EarlyTableOnCore = NULL;
  FamilySpecificServices->GetEarlyInitAfterApLaunchOnCoreTable (FamilySpecificServices, &EarlyTableOnCore, CpuEarlyParams, StdHeader);
  PerformEarlyInitTable (EarlyTableOnCore, FamilySpecificServices, CpuEarlyParams, StdHeader);
}
