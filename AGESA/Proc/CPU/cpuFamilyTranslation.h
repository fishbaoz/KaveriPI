 ...
 *
 */
typedef BOOLEAN F_IS_PSP_PRESENT (
  IN       AMD_CONFIG_PARAMS *StdHeader
  );

/// Reference to a Method.
typedef F_IS_PSP_PRESENT *PF_IS_PSP_PRESENT;
...
typedef VOID F_CPU_GET_SUBFAMILY_ID_ARRAY (
     ...
     OUT   UINT64 *HighestSupportedLogicalId,
  IN       AMD_CONFIG_PARAMS *StdHeader
  );
...
struct _CPU_SPECIFIC_SERVICES {                                                // See the Forwaqrd Declaration above
  ...
  REGISTER_TABLE                            **RegisterTableListAfterApLaunch;  ///< Public Data: The available register tables after AP launch.
  REGISTER_TABLE                            **RegisterTableListAfterApLaunchSecureS3; ///< Public Data: The available register tables after AP launch for SecureS3 path.
  REGISTER_TABLE                            **RegisterTableListBeforeApLaunch; ///< Public Data: The available register tables before AP launch.
  REGISTER_TABLE                            **RegisterTableListBeforeApLaunchSecureS3; ///< Public Data: The available register tables before AP launch for SecureS3 path.
  ...
  PF_IS_PSP_PRESENT                         IsPspDevicePresent;                ///< Method: Check if PSP device present.
