...
/* Register related definitions */
  ...
  typedef struct {
    _1BYTE_ALIGN UINT8 SpecialCaseIndex :4; ///< Special Case array index
    _1BYTE_ALIGN UINT8 RegisterSize :3; ///< For PCI, 1 = byte, 2 = word, else = dword.
                         ///< For MSR, don't care
