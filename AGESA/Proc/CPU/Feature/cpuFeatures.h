...
#define CPU_FEAT_BEFORE_RELINQUISH_AP     (0x0000000000000040ull)
#define CPU_FEAT_S3_FINAL_RESTORE         (0x0000000000000080ull)
...
typedef enum {
  ...
  CpuScs,                    ///< SCS Initialize
  PrefetchMode,              ///< CPU Prefetch Mode
  ConnectedStandby,          ///< Connected Standby
  CpuCC6ExitControl,         ///< CC6 exit control
