 ...
 * @e \$Revision: 289112 $   @e \$Date: 2014-04-07 09:18:21 -0500 (Mon, 07 Apr 2014) $
 *
 */
/*****************************************************************************
 *
 ...
 *----------------------------------------------------------------------------------------
 */
CONST CHAR8 ROMDATA str_FireProA[] = "AMD FirePro(TM) A";
...
CONST CHAR8 ROMDATA str_R[] = "AMD R-";
CONST CHAR8 ROMDATA str_FXTm[] = "AMD FX(TM)-";
