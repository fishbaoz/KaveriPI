 ...
 * @file
 *
 * AMD CPU Cache Flush On Halt Function for Family 15h Kaveri.
 *
 * Contains code to initialize Cache Flush On Halt feature for Family 15h Kaveri.
 *
...
#define FILECODE PROC_CPU_FAMILY_0X15_KV_CPUF15KVCACHEFLUSHONHALT_FILECODE
...
CONST CPU_CFOH_FAMILY_SERVICES ROMDATA F15KvCacheFlushOnHalt =
{
  0,
  SetF15KvCacheFlushOnHaltRegister
};
