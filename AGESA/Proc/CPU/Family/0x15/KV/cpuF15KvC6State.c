 ...
 * @file
 *
 * AMD Family_15 Kaveri C6 C-state feature support functions.
 *
 ...
 * @e \$Revision: 282863 $   @e \$Date: 2014-01-17 15:27:34 -0600 (Fri, 17 Jan 2014) $
 *
 */
/*
 ******************************************************************************
...
#define FILECODE PROC_CPU_FAMILY_0X15_KV_CPUF15KVC6STATE_FILECODE
  ...
  )
{
  ...
  CSTATE_CTRL2_REGISTER   CstateCtrl2;
  ...
  if ((EntryPoint & CPU_FEAT_AFTER_PM_INIT) != 0) {
    ...
    if (NbPwrGateEn == 1) {
      LibAmdMsrRead (MSR_MC4_CTL_MASK, &MsrRegister, StdHeader);
      MsrRegister |= (1 << 26);
      LibAmdMsrWrite (MSR_MC4_CTL_MASK, &MsrRegister, StdHeader);
      LibAmdMsrRead (MSR_MC4_CTL, &MsrRegister, StdHeader);
      MsrRegister |= (1 << 26);
      LibAmdMsrWrite (MSR_MC4_CTL, &MsrRegister, StdHeader);
    }
    ...
    CstateCtrl1.NbPwrGate0 = NbPwrGateEn;
    ...
    CstateCtrl1.NbPwrGate1 = NbPwrGateEn;
    ...
    // Initialize F4x11C
    PciAddress.AddressValue = CSTATE_CTRL2_PCI_ADDR;
    LibAmdPciRead (AccessWidth32, PciAddress, &CstateCtrl2, StdHeader);
    CstateCtrl2.NbPwrGate2 = NbPwrGateEn;
    LibAmdPciWrite (AccessWidth32, PciAddress, &CstateCtrl2, StdHeader);
 ...
 */
VOID
F15KvReloadMicrocodePatchAfterMemInit (
  IN       AMD_CONFIG_PARAMS *StdHeader
  )
{
...
CONST C6_FAMILY_SERVICES ROMDATA F15KvC6Support =
{
  0,
  F15KvIsC6Supported,
  F15KvInitializeC6,
