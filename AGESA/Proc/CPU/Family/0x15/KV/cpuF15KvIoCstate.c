 ...
 * @file
 *
 * AMD Family_15 Kaveri IO C-state feature support functions.
 *
...
CODE_GROUP (G3_DXE)
RDATA_GROUP (G3_DXE)
#define FILECODE PROC_CPU_FAMILY_0X15_KV_CPUF15KVIOCSTATE_FILECODE
...
VOID
STATIC
F15KvInitializeIoCstateOnCore (
  IN       VOID *CstateBaseMsr,
  IN       AMD_CONFIG_PARAMS *StdHeader
  );

BOOLEAN
F15KvIsCsdObjGenerated (
...
/*---------------------------------------------------------------------------------------*/
/**
 *  Enable IO Cstate on a family 15h Kaveri CPU.
  ...
  )
{
  ...
  if ((EntryPoint & CPU_FEAT_AFTER_PM_INIT) != 0) {
    ...
    TaskPtr.FuncAddress.PfApTaskI = F15KvInitializeIoCstateOnCore;
...
/*---------------------------------------------------------------------------------------*/
/**
 *  Enable CState on a family 15h Kaveri core.
 *
...
CONST IO_CSTATE_FAMILY_SERVICES ROMDATA F15KvIoCstateSupport =
{
  0,
