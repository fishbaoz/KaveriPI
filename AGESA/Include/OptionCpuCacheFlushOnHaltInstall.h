...
#define F15_KV_CPU_CFOH_SUPPORT
        ...
        #define OPTION_CPU_CACHE_FLUSH_ON_HALT_FEAT &CpuFeatureCacheFlushOnHalt,
          ...
          extern CONST CPU_CFOH_FAMILY_SERVICES ROMDATA F15KvCacheFlushOnHalt;
          #undef F15_KV_CPU_CFOH_SUPPORT
          #define F15_KV_CPU_CFOH_SUPPORT {AMD_FAMILY_15_KV, &F15KvCacheFlushOnHalt},
        #endif
      #endif
    #endif
