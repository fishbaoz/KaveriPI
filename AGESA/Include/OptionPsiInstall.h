...
#define F15_KV_PSI_SUPPORT
    ...
    // Family 15h
          ...
          #undef OPTION_CPU_PSI_FEAT
          #define OPTION_CPU_PSI_FEAT &CpuFeaturePsi,
          extern CONST PSI_FAMILY_SERVICES ROMDATA F15KvPsiSupport;
          #undef F15_KV_PSI_SUPPORT
          #define F15_KV_PSI_SUPPORT {AMD_FAMILY_15_KV, &F15KvPsiSupport},
        #endif
      #endif
    #endif
