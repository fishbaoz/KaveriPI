...
#define F15_KV_HTC_SUPPORT
          ...
          #undef OPTION_CPU_HTC_FEAT
          #define OPTION_CPU_HTC_FEAT &CpuFeatureHtc,
          extern CONST HTC_FAMILY_SERVICES ROMDATA F15KvHtcSupport;
          #undef F15_KV_HTC_SUPPORT
          #define F15_KV_HTC_SUPPORT {AMD_FAMILY_15_KV, &F15KvHtcSupport},
        #endif
      #endif
    #endif
