...
#define F15_KV_CPU_CORELEVELING_SUPPORT
    ...
    // Family 15h
      ...
      #define OPTION_CPU_CORE_LEVELING_FEAT &CpuFeatureCoreLeveling,
        ...
        extern CONST CPU_CORE_LEVELING_FAMILY_SERVICES ROMDATA F15KvCoreLeveling;
        #undef F15_KV_CPU_CORELEVELING_SUPPORT
        #define F15_KV_CPU_CORELEVELING_SUPPORT {AMD_FAMILY_15_KV, &F15KvCoreLeveling},
      #endif
    #endif
...
{
  F15_KV_CPU_CORELEVELING_SUPPORT
