...
#define IDS_LATE_RUN_AP_TASK
    ...
    CONST SCRIPT_FUNCTION ROMDATA ScriptFuncList[] = {
      { (UINT32) (VOID*) MemUWriteCachelines, "WriteCl(PhyAddrLo,BufferAddr,ClCnt)"},
      { (UINT32) (VOID*) MemUReadCachelines,  "ReadCl(BufferAddr,PhyAddrLo,ClCnt)"},
      { (UINT32) (VOID*) MemUFlushPattern,    "FlushCl(PhyAddrLo,ClCnt)"}
    };
...
#define OPTION_IDS_NV_TO_CMOS_END NV_TO_CMOS (IDS_NV_TO_CMOS_LEN_END, IDS_NV_TO_CMOS_ID_END)
      ...
      //Family 15h KV
      #ifndef OPTION_IDS_NV_TO_CMOS_F15_KV
        #define OPTION_IDS_NV_TO_CMOS_F15_KV
      #endif
...
/*----------------------------------------------------------------------------
 *                        Family 15 KV feat blocks
 *
 *----------------------------------------------------------------------------
 */
    #define OPTION_IDS_FEAT_HTC_CTRL_F15_KV
    #define OPTION_IDS_FEAT_MEMORY_MAPPING_F15_KV
    #define OPTION_IDS_FEAT_GNB_PLATFORMCFGF15KV
    #ifdef OPTION_FAMILY15H_KV
      #if OPTION_FAMILY15H_KV == TRUE
        extern CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatHtcControlBlockF15Kv;
        #undef OPTION_IDS_FEAT_HTC_CTRL_F15_KV
        #define OPTION_IDS_FEAT_HTC_CTRL_F15_KV\
                    &IdsFeatHtcControlBlockF15Kv,

        extern CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatMemoryMappingPostBeforeBlockF15Kv;
        extern CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatMemoryMappingChIntlvBlockF15Kv;
        #undef OPTION_IDS_FEAT_MEMORY_MAPPING_F15_KV
        #define OPTION_IDS_FEAT_MEMORY_MAPPING_F15_KV\
        &IdsFeatMemoryMappingPostBeforeBlockF15Kv,\
        &IdsFeatMemoryMappingChIntlvBlockF15Kv,

        extern CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatGnbPlatformCfgBlockF15Kv;
        #undef OPTION_IDS_FEAT_GNB_PLATFORMCFGF15KV
        #define OPTION_IDS_FEAT_GNB_PLATFORMCFGF15KV &IdsFeatGnbPlatformCfgBlockF15Kv,
      #endif
    #endif
  ...
  #define OPTION_IDS_FAM_REGACC_F15KV
  #ifdef OPTION_FAMILY15H_KV
    #if OPTION_FAMILY15H_KV == TRUE
      extern CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatRegGmmxF15Kv;
      #undef OPTION_IDS_FAM_REGACC_F15KV
      #define OPTION_IDS_FAM_REGACC_F15KV \
                  &IdsFeatRegGmmxF15Kv,
    #endif
  #endif
