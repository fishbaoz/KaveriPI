...
#include EFI_PPI_CONSUMER (AmdPlatformDimmSpdPpi)
#include EFI_PPI_CONSUMER (AmdIdsInterfacePpi)
  ...
  )
{
  ...
  PeiServices = (EFI_PEI_SERVICES **) ReadSpd->StdHeader.ImageBasePtr;
