 ...
 * @e project:      AGESA
 * @e sub-project   OSC out clock Service
...
#include "FchPeiLib.h"
#include "Filecode.h"
#define FILECODE UEFI_PEI_FCHPEIAUX_PEIOSCOUTCLOCK_FILECODE
  ...
  )
{
  ...
  if ( OscOut1ClockSel ) {
    ...
    if ( Value >= FCH_YANGTZE) {
      ...
      // Bolton or Hudson-2
      LibFchMemRMW8 ( PeiServices, MmioAddr + MISC_BASE + FCH_MISC_REG28 + 2, 0xF8, OscOut1ClockFreq);
      LibFchMemRMW8 ( PeiServices, MmioAddr + MISC_BASE + FCH_MISC_REG40, 0xFB, 0x00);
    }
  }
}
