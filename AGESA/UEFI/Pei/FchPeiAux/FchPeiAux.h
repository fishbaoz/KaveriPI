...
#include EFI_PPI_PRODUCER (AmdFchPeiAuxPpi)
...
#define FCH_PEI_AUX_PRIVATE_DATA_SIGNATURE   EFI_SIGNATURE_32 ('$', 'F', 'P', 'E')

#define FCH_PEI_PRIVATE_FROM_THIS(a) \
  (FCH_PEI_AUX_PRIVATE*) (PEI_CR ((a), FCH_PEI_AUX_PRIVATE, FchPeiAuxPpi, FCH_PEI_AUX_PRIVATE_DATA_SIGNATURE))
