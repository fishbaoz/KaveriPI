 ...
 * ***************************************************************************
 */
#ifndef _OEM_AGESA_CUSTOMIZE_H_
#define _OEM_AGESA_CUSTOMIZE_H_
...
OemCustomizeS3FinalRestore (
  IN  EFI_PEI_SERVICES   **PeiServices,
  IN  AMD_S3FINAL_PARAMS *S3FinalParams
  );
