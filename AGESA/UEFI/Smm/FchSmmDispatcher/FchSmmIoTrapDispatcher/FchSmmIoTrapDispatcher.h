...
#ifndef _FCHSMMIOTRAPDISPATCHER_H_
#define _FCHSMMIOTRAPDISPATCHER_H_

#include "FchSmmDispatcher.h"

#include EFI_PROTOCOL_DEFINITION (FchSmmIoTrapDispatch)

extern  FCH_SMM_IO_TRAP_DISPATCH_PROTOCOL gFchSmmIoTrapDispatchProtocol;
...
typedef struct {
  ...
  FCH_SMM_HANDLER_ENTRY_POINT           DispatchFunction;       ///< SMM handler entry point
} FCH_IO_TRAP_ENTRY;
