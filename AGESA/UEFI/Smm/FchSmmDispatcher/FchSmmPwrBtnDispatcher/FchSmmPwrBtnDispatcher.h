...
#ifndef _FCH_SMM_PWRBTN_DISPATCHER_H_
#define _FCH_SMM_PWRBTN_DISPATCHER_H_
...
extern  FCH_SMM_PWRBTN_DISPATCH_PROTOCOL gFchSmmPwrBtnDispatchProtocol;
...
typedef struct _FCH_SMM_PWRBTN_NODE {
  ...
  FCH_SMM_PWRBTN_HANDLER_ENTRY_POINT      CallBackFunction;       ///< SMM handler entry point
  FCH_SMM_PWRBTN_HANDLER2_ENTRY_POINT     CallBack2Function;      ///< SMM handler2 entry point
