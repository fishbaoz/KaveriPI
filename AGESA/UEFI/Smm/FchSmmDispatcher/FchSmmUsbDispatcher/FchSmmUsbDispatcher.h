...
extern  FCH_SMM_USB_DISPATCH_PROTOCOL gFchSmmUsbDispatchProtocol;
...
typedef struct _FCH_SMM_USB_NODE {
  ...
  FCH_SMM_USB_HANDLER_ENTRY_POINT      CallBackFunction;       ///< SMM handler entry point
  FCH_SMM_USB_HANDLER2_ENTRY_POINT     CallBack2Function;      ///< SMM handler entry point
