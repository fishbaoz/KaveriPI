...
extern  FCH_SMM_PERIODICAL_DISPATCH_PROTOCOL gFchSmmPeriodicalDispatchProtocol;
...
typedef struct _FCH_SMM_PERIODICAL_NODE {
  ...
  FCH_SMM_PERIODICAL_HANDLER_ENTRY_POINT      CallBackFunction;           ///< SMM handler entry point
