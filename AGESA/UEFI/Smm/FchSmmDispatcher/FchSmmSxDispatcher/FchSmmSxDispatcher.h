...
extern  FCH_SMM_SX_DISPATCH_PROTOCOL  gFchSmmSxDispatchProtocol;
...
typedef struct _FCH_SMM_SX_NODE {
  ...
  FCH_SMM_SX_HANDLER_ENTRY_POINT     CallBackFunction;       ///< SMM handler entry point
  FCH_SMM_SX_HANDLER2_ENTRY_POINT    CallBack2Function;      ///< SMM handler2 entry point
