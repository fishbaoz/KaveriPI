...
EFI_DRIVER_ENTRY_POINT (AgesaDxeDriverEntryPoint);
 ...
 *
 *  Description:
 *     This functions returns the DIMM details if physical address is supplied
 *
 *  Parameters:
 *    @param[in]      *This
 *    @param[in, out] *DimmInfo
 *
 *    @retval         EFI_STATUS
 *
 *---------------------------------------------------------------------------------------
...
EFI_STATUS
AgesaGetDimmInfo (
  IN       AMD_AGESA_MISC_SERVICES_PROTOCOL *This,
  IN OUT   AMD_IDENTIFY_DIMM                *DimmInfo
  )
{
  AGESA_STATUS    AgesaStatus;
  ...
  AgesaStatus = AmdIdentifyDimm (DimmInfo);
