...
typedef struct _FCH_DXE_LPCCLK_PRIVATE {
  UINTN                            Signature;                ///< Signature
  FCH_DXE_LPCCLK_INIT_PROTOCOL     FchDxeLpcClkRunInit;      ///< FCH Dxe LpcClkRun
  AMD_CONFIG_PARAMS                StdHdr;                   ///< AMD_CONFIG_PARAMS
} FCH_DXE_LPCCLK_PRIVATE;

#define FCH_DXE_LPCCLK_PRIVATE_DATA_SIGNATURE   EFI_SIGNATURE_32 ('S', 'B', 'i', 'L')

#define FCH_DXE_PRIVATE_FROM_THIS(a) \
 (FCH_DXE_LPCAUX_PRIVATE*) (CR (a, FCH_DXE_LPCCLK_PRIVATE, FchDxeLpcClkRunInit, FCH_DXE_LPCCLK_PRIVATE_DATA_SIGNATURE))
