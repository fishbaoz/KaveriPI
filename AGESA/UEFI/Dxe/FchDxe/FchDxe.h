...
// Protocols
#include EFI_PROTOCOL_PRODUCER (FchInitProtocol)
#include EFI_PROTOCOL_PRODUCER (FchInitDonePolicyProtocol)
#include EFI_PROTOCOL_CONSUMER (AmdBufferManagerProtocol)
...
#define FCH_DXE_PRIVATE_DATA_SIGNATURE   EFI_SIGNATURE_32 ('S', 'B', 'i', 'D')
